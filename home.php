...
<div class="menuBox adminHome">
    <div class="menuBoxInner">
        <div class="per_title">
            <h5><?php echo __('<strong>ADMINISTRASI PERPUSTAKAAN</strong> SD MARSUDIRINI YOGYAKARTA'); ?></h5>
        </div>
    </div>
</div>
...
<div class="contentDesc">
    <div class="container-fluid">
        ...
        if ($num_overdue > 0) {
            $warnings[] = str_replace('{num_overdue}', $num_overdue, __('Saat ini <strong>{num_overdue}</strong> orang Anggota Perpustakaan yang terlambat mengembalikan buku. Silakan cek di menu <b>Sirkulasi</b> submenu <b>Daftar Terlambat</b> untuk lebih detail.')); //mfc
        ...
        if ($_SESSION['uid'] === '1') {
            $warnings[] = __('<strong><i>masexo</i></strong>');
            ...
            <div class="col-xs-6 col-md-3 col-lg-3">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <div class="s-widget-title"><?php echo __('Total Koleksi Judul Buku') ?></div>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 col-md-3 col-lg-3">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <div class="s-widget-title"><?php echo __('Total Eksemplar') ?></div>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 col-md-3 col-lg-3">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <div style='color:red;' class="s-widget-value item_total_lent">0</div>
                        <div style='color:red;' class="s-widget-title"><?php echo __('Eksemplar sedang <strong>DIPINJAM</strong>') ?></div>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 col-md-3 col-lg-3">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <div class="s-widget-title"><?php echo __('Eksemplar Yang Masih Tersedia') ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col col-md-8 s-dashboard">
                <div class="card border-0">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo __('Update Sirkulasi Harian') ?></h5>
            ...
            <div class="col col-md-4 s-dashboard">
                <div class="card border-0">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo __('RINGKASAN BUKU') ?></h5>
                        <div class="s-chart">
                        ...
                        <table class="table">
                            <tr>
                                <td class="text-left"><i class="fa fa-square"
                                                         style="color:#f2f2f2;"></i>&nbsp;&nbsp;<?php echo __('Total Telah Dipinjam') ?>
                                </td>
                                <td class="text-right loan_total">0</td>
                            </tr>
                            <tr>
                                <td class="text-left"><i class="fa fa-square"
                                                         style="color:#337AB7;"></i>&nbsp;&nbsp;<?php echo __('SEDANG DIPINJAM') ?>
                                </td>
                                <td class="text-right loan_new">0</td>
                            </tr>
                            <tr>
                                <td class="text-left"><i class="fa fa-square"
                                                         style="color:#06B1CD;"></i>&nbsp;&nbsp;<?php echo __('Total Dikembalikan') ?>
                                </td>
                                <td class="text-right loan_return">0</td>
                            </tr>
                            <tr>
                                <td class="text-left"><i class="fa fa-square"
                                                         style="color:#4AC49B;"></i>&nbsp;&nbsp;<?php echo __('Peminjaman Diperpanjang') ?>
                                </td>
                                <td class="text-right loan_extend">0</td>
                            </tr>
                            <tr>
                                <td class="text-left"><i class="fa fa-square"
                                                         style="color:#F4CC17;"></i>&nbsp;&nbsp;<?php echo __('<strong>Pengembalian Hari ini+Terlambat</strong>') ?>
                                </td>
                    ...
                    let data = [
                        {
                            ...
                            color: "#f2f2f2",
                            label: "<?php echo __('Total Telah Dipinjam'); ?>"
                        },
                        {
                            value: parseInt(res.data.new),
                            color: "#337AB7",
                            label: "<?php echo __('Jumlah Sedang Dipinjam'); ?>"
                        },
                        {
                            value: parseInt(res.data.return),
                            color: "#06B1CD",
                            label: "<?php echo __('Total Telah Dikembalikan'); ?>"
                        },
                        {
                            value: parseInt(res.data.extend),
                            color: "#4AC49B",
                            label: "<?php echo __('Perpanjangan Peminjaman'); ?>"
                        },
                        {
                            value: parseInt(res.data.overdue),
                            color: "#F4CC17",
                            label: "<?php echo __('TERLAMBAT+Jatuh Tempo'); ?>" // sebelumnya Overdue
                        }
